...
rem snasm68k.exe -emax 0 -p -o ae- s1comb.asm, S1_Legends.bin
asm68k /o op+ /o os+ /o ow+ /o oz+ /o oaq+ /o osq+ /o omq+ /p /o ae- sonic1.asm, S1_Legends.bin
rompad.exe S1_Legends.bin 255 0
